...
## Correct names for spacing, subset to cumberland county towns
print("correcting spacing in data")
tick_disease_big$Location <- gsub(" ", "_", tick_disease_big$Location)
tick_disease <- tick_disease_big[as.matrix(tick_disease_big$Location) %in% as.matrix(towns_in_cumberland), ]
