...
s = mean_year_year_variability / (year_to_year_variability*2) # rior for year-year variability plus and order of magnitude
a = s * mean_year_year_variability # Gamma for prior
