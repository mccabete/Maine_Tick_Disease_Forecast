...
if(is.na(burnin)){
  ...
  file_name <- paste("/Users/tess/Documents/work/Maine_Tick_Disease_Forecast/Jags_output/", date_stamp, ".", "binomial_simple",".",town_name,".", did_it_converge, ".","JAGS_run.Rdata", sep = "")
