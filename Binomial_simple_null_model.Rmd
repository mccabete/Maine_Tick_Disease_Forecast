...
model{
  ...
  #### Process Model
   for (i in 2:n){
    ...
    probability[i] <- max(dummy[i], 1.622593e-07) # probability can get very small but can't go negative or to zero
...
print(town_name)
output <- fit_binomial_null(tick_data = tick_disease_tmp, has_suppressed = TRUE, town_name, n.iter = 50000, data_list)
