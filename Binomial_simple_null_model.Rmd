...
model{
  ...
  ## Prior
  probability[1] ~ dbeta(prob_a,prob_b) #uniform probability
...
model{
  ...
  #### Priors
  probability[1] ~ dbeta(prob_a,prob_b) 
  yearly_error ~ dnorm(mean_error, 1/var_error)
}
"
  }
...
print(town_name)
output <- fit_binomial_null(tick_data, has_suppressed = TRUE, town_name, n.iter = 1000, data_list)
