...
## For lnorm error
data_list <- list(less_than_six_indices = points_of_less_than_six, numeric_indices =numeric_indices, n = 10, a_obs = 2, r_obs = 0.5 , a_add = 2, r_add = 0.5,  y = tick_disease_tmp$Number,  x_ic = 20, tau_ic = 1)
...
jags.out   <- coda.samples (model = j.model,
                            variable.names = c( "tau_add", "x", "tau_obs"),
                                n.iter = n.iter)
