...
# For binom error
data_list <- list(less_than_six_indices = points_of_less_than_six, numeric_indices =numeric_indices, n = 10, a_obs = beta_of_true_tick_rate$alpha, b_obs = beta_of_true_tick_rate$beta , a_add = 2, r_add = 0.5,  y = as.numeric(tick_disease_tmp$Number),  x_ic = 55, tau_ic = 1,yearly_error = 2)
...
jags.out   <- coda.samples (model = j.model,
                            variable.names = c( "step_direction", "x", "false_negative"),
                                n.iter = n.iter)
