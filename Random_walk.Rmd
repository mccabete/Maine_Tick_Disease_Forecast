...
for (i in seq_along(towns_in_rest_of_maine)){
  ...
  tick_disease_tmp$Number[tick_disease_tmp$Year > 2016] <- NA 
...
freeport <- fit_random_walk(tick_data, has_suppressed = TRUE, town_name, n.iter = 190000, data_list, init_detection_rate = 0.9999, init_ic = val_2008 + 2, init_data )
