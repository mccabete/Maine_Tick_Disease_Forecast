...
## Read in data
```{r}
towns_with_jags_output <- list.files("/Maine_Tick_Disease_Forecast/Jags_output/")
...
for(i in seq_along(towns_with_jags_output)){
  file_path <- paste("/Maine_Tick_Disease_Forecast/Jags_output/", file_names[i], sep = "")
  load(file_path)
...
file_path_export <- paste("/Maine_Tick_Disease_Forecast/modeled_output/", towns_with_jags_output[i], "_confidence_interval_binomial_null_ouput.csv", sep = "")
