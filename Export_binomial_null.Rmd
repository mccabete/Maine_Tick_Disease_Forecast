...
towns_with_jags_output <- towns_with_jags_output[grep("20191125.rate_random_walk.", towns_with_jags_output)]
file_names <- towns_with_jags_output
towns_with_jags_output <- gsub("20191125.rate_random_walk.", "", towns_with_jags_output)
