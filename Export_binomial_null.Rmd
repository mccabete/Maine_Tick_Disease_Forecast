...
towns_with_jags_output <- towns_with_jags_output[grep("20191203.binomial_censored.", towns_with_jags_output)]
file_names <- towns_with_jags_output
towns_with_jags_output <- gsub("20191203.binomial_censored.", "", towns_with_jags_output)
...
for(i in seq_along(towns_with_jags_output)){
  ...
  tick_data <- dplyr::arrange(tick_data, by =  tick_data$Year) %>%
                       dplyr::distinct()
