...
for (i in seq_along(towns_to_run)){
  ...
  data_list <- list(less_than_six_indices = less_than_six_indices, numeric_indices =numeric_indices, n = 7, a_obs = beta_of_true_tick_rate$alpha, b_obs = beta_of_true_tick_rate$beta , 
